...
_bsn.AutoSuggest = function (fldID, param)
{
	...
	if (!this.oP.bible)		this.oP.bible = 1;
	if (this.oP.bible === 4)	this.oP.bible = 1;
	if (!this.oP.cmode)		this.oP.cmode = 0;
	if (!this.oP.method)		this.oP.meth = "get";
	if (!this.oP.varname)		this.oP.varname = "input";
	if (!this.oP.className)		this.oP.className = "autosuggest";
	if (!this.oP.timeout)		this.oP.timeout = 23500;
...
_bsn.AutoSuggest.prototype.doAjaxRequest = function ()
{
	var pointer = this;
	// create ajax request
	var dovar = encodeURI(this.fld.value);
	var url = this.oP.script+this.oP.varname+"="+escape(dovar)+"&b="+this.oP.bible+"&m="+this.oP.cmode+"&tri="+this.oP.tri;
...
_bsn.AutoSuggest.prototype.createList = function(arr)
{
	...
	ul.style.width = "800px";//this.fld.offsetWidth+
